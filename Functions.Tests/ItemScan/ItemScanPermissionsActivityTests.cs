...
//
//            //Act
//            var fun = new ItemScanPermissionsActivity(azure.Object,
...
//           
//             //Act
//             var fun = new ItemScanPermissionsActivity(clientMock.Object,
//                 fixture.Create<EnvironmentConfig>(),
//                 new Mock<ITokenizer>().Object);
//
...
//            
//             var function = new ItemScanPermissionsActivity(new Mock<IVstsRestClient>().Object,
//                 fixture.Create<EnvironmentConfig>(), 
//                 tokenizer.Object);
//            
...
//             request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", "");
//            
//             var function = new ItemScanPermissionsActivity(azure.Object,
//                 fixture.Create<EnvironmentConfig>(), 
//                 tokenizer.Object);
//            
//             var result = await function.RunFromHttp(request , 
