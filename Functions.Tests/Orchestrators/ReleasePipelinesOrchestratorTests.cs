...
namespace Functions.Tests.Orchestrators
{
    public class ReleasePipelinesOrchestratorTests
    {
        ...
        public async Task ShouldCallActivityAsyncForProject()
        {
            ...
            starter
                .Setup(x => x.CallActivityWithRetryAsync<ItemExtensionData>(
                    ...
                    It.IsAny<(Project, ReleaseDefinition, List<DeploymentMethod>)>()))
        ...
        [Fact]
        public async Task RunAsync_WithEmptyProductionItemList_ShouldInvokeGetDeploymentMethodsActivity()
        {
            //Arrange
            _fixture.Customize<ReleaseDefinition>(f => f
                 .With(r => r.Id, "1"));
            ...
            starter
                .Setup(x => x.GetInput<(Project, List<ProductionItem>)>())
                .Returns((_fixture.Create<Project>(), new List<ProductionItem>()));
            ...
            starter
                .Setup(x => x.CallActivityWithRetryAsync<List<ProductionItem>>(
                    nameof(GetDeploymentMethodsActivity), It.IsAny<RetryOptions>(),
                    It.IsAny<Project>()))
                .ReturnsAsync(_fixture.Create<List<ProductionItem>>())
                .Verifiable();
