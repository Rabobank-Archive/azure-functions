...
{
    public class CreateHooksActivityTests
    {
        ...
        public async Task NoSubscriptions_HooksCreated()
        {
            ...
            var existingHooks = fixture.CreateMany<Response.Hook>().ToList();
            var project = fixture.Create<Response.Project>();

            // Act
            var function = new CreateHooksActivity(
            ...
            await function.RunAsync((existingHooks, project));
