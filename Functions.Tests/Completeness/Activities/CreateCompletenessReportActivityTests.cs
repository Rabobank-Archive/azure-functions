...
{
    public class CreateCompletenessReportActivityTests
    {
        private readonly Fixture _fixture;

        public CreateCompletenessReportActivityTests()
        {
        ...
        public void ShouldReturnCountIfTotalProjectCountPresent(int count)
        {
            ...
            // Act
            var fun = new CreateCompletenessReportActivity();
            var completedReport = fun.Run(request);

            // Assert
            completedReport.TotalProjectCount.ShouldBe(count);
        }
        ...
        public void ShouldReturnNullIfNoTotalProjectCountPresent()
        {
            ...
            // Assert
            completedReport.TotalProjectCount.ShouldBeNull();
        }
