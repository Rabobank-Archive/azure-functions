...
{
    public class UploadCompletenessReportActivity
    {
        private readonly ILogAnalyticsClient _client;

        public UploadCompletenessReportActivity(ILogAnalyticsClient client)
        {
            _client = client;
        }

        [FunctionName(nameof(UploadCompletenessReportActivity))]
