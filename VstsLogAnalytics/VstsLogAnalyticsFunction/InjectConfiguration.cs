...
[assembly: WebJobsStartup(typeof(InjectConfiguration))]
...
namespace VstsLogAnalytics.Common
{
    public class InjectConfiguration : IWebJobsStartup
    {
        public void Configure(IWebJobsBuilder builder)
        {
            ...
            builder.Services.AddTransient<IMemoryCache>(_ => new MemoryCache(new MemoryCacheOptions()));
        }
        ...
        private static void RegisterVstsRestClient(IServiceCollection services)
        {
            ...
            services.AddTransient<IVstsRestClient>(_ => new VstsRestClient("somecompany", token));
        }
        ...
        private static void RegisterLogAnalyticsClient(IServiceCollection services)
        {
            ...
            services.AddTransient<ILogAnalyticsClient>(_ => new LogAnalyticsClient(workspace, key));
        }
    }
}